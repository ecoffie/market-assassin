...
| 8 | `search_past_contracts` | `naics: "336612"` | **fixed** | `15c6b861`: `naicsCode: ""`, `queriedNaics: "336612"`, `recipientState: ""`, `popState: "LA"`, `_meta.field_status.pop_state = place_of_performance_not_recipient_hq`. |
...
| 11 | `extract_statement_of_work` | `notice_id: "N00024-26-R-2200"` | **fixed** | `15c6b861`: `piee: true`, `found: false`, `piee_links` → piee.eb.mil, `unread_attachments: 1`, `retrieval_limitation` states unread PIEE package. |
