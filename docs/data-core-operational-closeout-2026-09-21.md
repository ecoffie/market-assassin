...
| Institute / Strategic | Congress (NDAA) | **29** | `institute-legislation-sync` | instance, `upstream_quiet` + `blocked` | **NOT CURRENT** — watermark 07-30, data clock held | 29/29 URL | 28/29 DoD | **reaches no surface** (verified: 0 derived pain points) | **PARKED / BLOCKED_CONTROLLED** | — | no `CONGRESS_API_KEY` in production | broader legislation |
