 ...
 * (the grant cron excludes COMP_TESTIMONIAL_EMAILS). This sets EVERY comp/testimonial to 500.
...
const COMP_CAP = 500; // every comp/testimonial (incl. Ryan) → 500 one-time, no refill
