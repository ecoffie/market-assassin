...
try {
  ...
  for (const t of ['get_pricing_intel', 'get_incumbent_financials', 'get_regulatory_demand', 'get_solicitation_documents']) {
  ...
  console.error('\n✅ SMOKE PASSED — MCP transport + 14 tools (playbook, pricing-intel, EDGAR, Federal Register, award-detail, predecessor-award, sam-entity, search-contractors, agency-intel, grants, forecasts, sbir, expiring-contracts, solicitation-documents) all live + honest');
  await client.close();
  process.exit(0);
} catch (err) {
