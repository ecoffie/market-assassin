#!/usr/bin/env node
/**
 * Test script for Treasury OSDBU Forecast Scraper
 *
 * Usage:
...
async function main() {
  ...
  console.log('Treasury OSDBU Forecast Scraper Test');
  console.log('='.repeat(60));
  console.log();

  try {
    // Dynamic import for ES module
    const scraperModule = await import(path.join(process.cwd(), 'src/lib/forecasts/scrapers/treasury.ts'));
    const { scrapeTreasury } = scraperModule;
