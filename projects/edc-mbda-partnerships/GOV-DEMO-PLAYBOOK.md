# Government Demo Playbook — 3 Warm Contacts, 3 Prototypes

**The state of play:** three warm government contacts, each with a stated need, each with a working
prototype live on the demo account. This is the index — open the specific runbook before each demo.

**Demo account (all three):** https://getmindy.ai/app → `disa-demo@getmindy.ai` / `DisaDemo!2026`

---

## The three

| Contact | Need (their words) | Prototype | Panel | Runbook |
|---|---|---|---|---|
...
## The product story (use across all three)

**One engine, three jobs.** The PSC-scored capable-business search powers:
- Navy OSBP sourcing (find the firms)
- §11/§12 of the Army MRR (document the firms + set-aside rec)
- and the recompete/award spine powers DISA's expiry watch.

Pitch line: *"Same source of truth — real federal award data — whether you're sourcing small
businesses, documenting a market research report, or tracking expiring vehicles."*

## The honesty rule (every demo)
...
## Universal close
Don't ask for a contract. Ask for: **their real codes/requirement** + **permission to run a pilot
on their data** (no cost). Land the pilot → expand. (The Anduril move: solve the real problem,
small, then grow.)
