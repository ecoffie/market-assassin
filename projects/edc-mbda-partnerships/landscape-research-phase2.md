# EDC / MBDA Landscape Research — Phase 2

**Status:** IN PROGRESS (started June 14, 2026)  
**Owner:** Eric (until FT hire)  
**Due:** Jul 15, 2026 (per PRD §10)  
**Method:** Every row must cite a real source URL or primary contact page — no LLM guesses.

---

## 1. EDC top targets — federal contracting programs

Priority states: **MD, GA, TX, FL, VA, CA** (per PRD).

| # | Organization | State | GovCon program | Contact | APEX overlap | Source | Status |
|---|--------------|-------|----------------|---------|--------------|--------|--------|
| 1 | **Prince George's County EDC** | MD | Procurement 360: Targeting Opportunities (bi-monthly); GovCon Academy w/ MBCC | Kimberlee Andrews — kbandrews@co.pg.md.us, 301-583-4609 | Likely refers to MD APEX | [pgcedc.com/procurement360](https://www.pgcedc.com/procurement360) | **P1 — outreach this week** |
| 2 | **San Antonio Economic Development** | TX | Vendor Development Academy (1-yr cohort; apps open through Jul 1, 2026) | Glenn Goolsby — program admin (see sa.gov page) | TX APEX network | [sa.gov Vendor Development Academy](https://www.sa.gov/Directory/Departments/EDD/Programs-Grants/Vendor-Development-Academy) | Research |
...
## 3. NMSDC regional councils (23 affiliates)

Certify **17,000+ MBEs**; connect to **1,700+ corporate buyers** (nmsdc.org, 2026 site copy).

| Region bucket | Councils (verified names) | Priority for advisor |
|---------------|---------------------------|----------------------|
| Region 1 | North Central, Northwest Mountain, Mountain Plains, Western Regional | Low (post-NAPEX) |
| Region 2 | Pacific Southwest, Southern California, Southwest, Dallas/Fort Worth | **TX advisor** |
| Region 3 | Chicago, Michigan, Mid-States, Ohio | Midwest |
| Region 4 | Capital Region, Eastern, Greater New England, New York & New Jersey | **MD/VA adjacency** |
| Region 5 | Florida State, Georgia, Puerto Rico | **GA advisor — P2** |
| Region 6 | Carolinas-Virginia, Houston, Southern Region, TriState | **Carolinas-Virginia + Houston first** |
...
## 5. WIOA boards (P3 — defer until one EDC eval live)

| Board | State | Veteran / GovCon angle | Contact | Status |
|-------|-------|------------------------|---------|--------|
| *TBD* | MD | Near PGC pilot | | Open |
| *TBD* | TX | San Antonio cohort overlap | | Open |
| *TBD* | GA | | | Open |
| *TBD* | VA | | | Open |
| *TBD* | FL | | | Open |

~550 local boards nationwide (DOL). Scan after first EDC case study.
...
## 7. Pricing validation log

Target: **3 discovery calls at $50K EDC price point** before standardizing.

| Date | Org | Reaction to $50K cohort | Notes |
|------|-----|-------------------------|-------|
| | PGC EDC | | First call |
