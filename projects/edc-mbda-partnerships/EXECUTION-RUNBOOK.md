...
| `DISA-VEHICLE-WATCH-SPEC.md` | **DISA prototype build spec** — automate expiry-watch + incumbent notification (replaces their manual IDIQ/IDV spreadsheet tracking). First prototype to build. |
