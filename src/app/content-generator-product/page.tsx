...
export default function ContentGeneratorProductPage() {
  return (
    <ProductPageAppSumo
      ...
      videoSubtitle="See how to generate LinkedIn posts in seconds"
