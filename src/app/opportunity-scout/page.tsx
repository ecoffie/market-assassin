            ...
            <div className="flex justify-end gap-3">
              {isPro ? (
                <>
                  ...
                  <a
                    href={`/market-assassin?naics=${encodeURIComponent(formData.naicsCode || '')}&type=${encodeURIComponent(formData.businessFormation || '')}&zip=${encodeURIComponent(formData.zipCode || '')}`}
