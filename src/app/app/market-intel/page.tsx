    ...
    try {
      const res = await fetch('/api/pipeline', {
        ...
        body: JSON.stringify({
          ...
          external_url: `/opportunity-map?src=market_intel&opp=${encodeURIComponent(opp.notice_id)}`,
          stage: 'tracking',
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <a
                      href={`/opportunity-map?src=market_intel&opp=${encodeURIComponent(opp.notice_id)}`}
