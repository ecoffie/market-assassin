 ...
 *
 * GET /api/mi-beta/comments?pipeline_id=xxx&email=xxx - List comments for a pursuit
 * POST /api/mi-beta/comments - Add a comment
 * DELETE /api/mi-beta/comments - Delete a comment
 */
