...
// NAICS query-time expansion is the SHARED curated table now (naics-briefing-expansion.ts) — same
// per-code fallback fix as the other briefing routes. Aliased so the call site doesn't churn.
...
<body>
  <div class="container">
    <div style="background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); padding: 10px 20px; text-align: center;">
      <p style="color: white; margin: 0; font-size: 12px; font-weight: 600;">🎁 FREE DURING BETA • Full Mindy market intelligence at no charge!</p>
    </div>
    ...
    <div class="footer">
      <p>Generated by <strong>Mindy</strong></p>
      <p><a href="${preferencesUrl}">Open Mindy Dashboard</a> | <a href="${preferencesUrl}">Manage Preferences</a></p>
      <p style="color: #94a3b8; font-size: 11px;">© ${new Date().getFullYear()} Mindy • getmindy.ai</p>
    </div>
  </div>
</body>
</html>
