...
export async function POST(request: NextRequest) {
  try {
    ...
    if (existingShare) {
      ...
      const shareUrl = `${process.env.NEXT_PUBLIC_APP_URL || 'https://getmindy.ai'}/shared/opp/${existingShare.share_id}`;
      return NextResponse.json({
        success: true,
        shareUrl,
    ...
    const shareUrl = `${process.env.NEXT_PUBLIC_APP_URL || 'https://getmindy.ai'}/shared/opp/${shareId}`;
