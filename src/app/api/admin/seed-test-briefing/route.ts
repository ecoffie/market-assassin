  ...
  try {
    ...
    const mockAwards = [
      ...
      },
      {
        ...
        totalObligation: 8750000,
        agency: 'Department of Veterans Affairs',
        naicsCode: '541511',
        awardDate: new Date(Date.now() - 172800000).toISOString(),
        description: 'Healthcare IT Modernization Support',
      },
    ];
