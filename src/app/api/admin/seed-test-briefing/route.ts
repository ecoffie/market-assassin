...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Real contract numbers from USASpending for testing
    const mockRecompetes = [
      {
        contractNumber: 'W91RUS18C0024',
        orderNumber: null,
        piid: 'W91RUS18C0024',
        incumbentName: 'BOOZ ALLEN HAMILTON INC',
        incumbentDuns: null,
        incumbentCage: null,
        obligatedAmount: 25158928,
        baseAndAllOptionsValue: 30000000,
        naicsCode: '541512',
        naicsDescription: 'Computer Systems Design Services',
        psc: 'D302',
        contractingOffice: 'W91RUS',
        contractingOfficeName: 'ACC-RSA',
      ...
      {
        contractNumber: 'W91QVN19F0222',
        orderNumber: null,
        piid: 'W91QVN19F0222',
        incumbentName: 'BOOZ ALLEN HAMILTON INC',
        incumbentDuns: null,
        incumbentCage: null,
        obligatedAmount: 7135630,
        baseAndAllOptionsValue: 10000000,
        naicsCode: '541519',
        naicsDescription: 'Other Computer Related Services',
        psc: 'D399',
        contractingOffice: 'W91QVN',
        contractingOfficeName: 'ACC',
        agency: 'Department of Defense',
        department: 'Department of Defense',
    ...
    if (!briefing || briefing.totalItems === 0) {
      return NextResponse.json({
        success: false,
        message: 'Snapshots seeded but briefing generation returned 0 items.',
        email,
        seedResults: results,
      });
    }
