  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-white mb-3">Opportunity Muted</h1>
        ...
        <p className="text-slate-500 mb-8">
          You won&apos;t see this opportunity in future briefings.
        </p>
...
export default function MuteSuccessPage() {
  return (
    <Suspense fallback={
