...
function ErrorContent() {
  ...
  const errorMessages: Record<string, string> = {
    ...
    db_error: 'There was a problem saving your preference.',
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-white mb-3">Couldn&apos;t Mute Opportunity</h1>
...
export default function MuteErrorPage() {
  return (
    <Suspense fallback={
