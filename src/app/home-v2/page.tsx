/**
 * /home-v2 — hero-copy variant of the logged-in home (GOS Decisions #010-#012).
 * Identical to /home EXCEPT the hero copy: eyebrow "Government contracting for everyone",
 * H1 "Send your agent to the government", and an enemy-named sub — the early-Robinhood
 * "[benefit] for [audience] + name the enemy" structure applied to the agentic bet.
 * Kept as a separate route so /home stays intact for side-by-side comparison.
 *
 * Preview: pass ?email=<user> to render that user's real stats. Not yet wired as the
 * post-signin destination — this is a copy-comparison build for sign-off.
 */
...
export default async function LoggedInHomeV2({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
      ...
      <main className="wrap" id="top">
        ...
        <section className="hero">
          <div className="card connect">
            ...
            <div className="eyebrow" style={{ color: '#d8b4fe' }}>Government contracting for everyone</div>
            <h2 className="disp">Send your agent<br />to the government.</h2>
            <div className="sub">No $10K tools, no gurus. Connect the AI agent you already use — Mindy finds your contracts, sizes your market, and drafts your bids. Just ask.</div>
            <div className="cta">
