...
export const MCP_CONNECTOR_INSTRUCTIONS = [
  ...
  '  (notice_id + agency) — not get_agency_intel alone. Present the three sections:',
  '  opportunity says / agency research / emphasize. Do not draft capability statements,',
  '  responses, or meeting briefs until those tools ship.',
