...
/**
 * Free credits granted ONE-TIME on a user's FIRST API key (env-tunable via
 * MCP_SIGNUP_CREDITS). Default 100 (decided 2026-07-13): a one-time B2B trial —
 * ≈ 4 capable-scans / 20 profiles / 100 SAM searches, enough to run one real
 * evaluation before buying a pack. NOT a recurring monthly grant (that would leak
 * margin-heavy BQ scans to non-payers); paid Pro subs get a monthly allowance
 * separately via PRO_MONTHLY_CREDITS.
 */
