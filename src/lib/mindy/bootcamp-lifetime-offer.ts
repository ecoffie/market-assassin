...
<p>So here's the bootcamp offer — and it's the best deal we'll ever run:</p>
<div style="margin:20px 0;padding:20px;border:1px solid #7c3aed;border-radius:14px;background:linear-gradient(135deg,#1e3a8a0d,#7c3aed14);">
  <p style="margin:0 0 6px;font-weight:700;font-size:18px;color:#111827;">The Ultimate Giant Bundle — $1,497, one time, forever</p>
...
<p>At $149/mo, Mindy alone pays this back in under a year — then it's free for life. The rest of the suite is the bonus.</p>
<p style="margin:24px 0;"><a href="${ULTIMATE_CHECKOUT_URL}" style="display:inline-block;background:linear-gradient(135deg,#1e3a8a,#7c3aed);color:#fff;text-decoration:none;padding:14px 30px;border-radius:10px;font-weight:600;font-size:16px;">Get lifetime access — $1,497 →</a></p>
<p style="color:#b91c1c;font-weight:600;">This bootcamp price closes ${deadlineLabel}. After that it's back to monthly only.</p>
<p>Go build something,</p>
<p>Eric Coffie<br/>GovCon Giants</p>
<p style="color:#6b7280;font-size:14px;margin-top:24px;">P.S. If lifetime isn't the move right now, Mindy is still free to use for daily alerts — just keep showing up. But the $1,497 door only stays open through ${deadlineLabel}.</p>
`;
