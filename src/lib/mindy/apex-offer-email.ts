...
/**
 * Mindy Day "Earn Your Way In" — the referral offer (slide 123 of the
 * launch deck). Sent to Mindy Day registrants who did NOT purchase over the
 * weekend. Make one warm intro to ANY org that helps small biz win gov contracts
 * (APEX Accelerator / SBDC / a trade association like AGC or ABC / EDO / Economic
...
// ONE copy-paste script the recipient sends to their contact. Works whether or
// not they've used Mindy — they just forward it. This is the answer to "what do
// I even say?" — they don't have to think, just copy.
const INTRO_SCRIPT = templateCard(
  'Copy & send this to your contact',
  'A tool worth 20 minutes for the businesses you help?',
  `Hi [Name],<br><br>
   There's an AI tool from GovCon Giants called <strong>Mindy</strong> that helps small businesses find and win federal contracts — it looks like a strong fit for the businesses you support.<br><br>
   Would you be open to a quick 20&ndash;30 minute look? If so, I'll connect you with the founder to find a time.<br><br>
   Thanks!<br>[Your Name]`,
);
...
<body style="margin: 0; padding: 0; background-color: #f8fafc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #1e293b;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;">Not going lifetime today? Make one warm intro to any organization that helps small businesses win government contracts — and we'll credit your account a full year of Pro ($1,788).</div>
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; padding: 40px 16px;"><tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
      <tr><td style="background: linear-gradient(135deg, #1e3a8a 0%, #6d28d9 55%, #7c3aed 100%); padding: 38px 32px; text-align: center;">
        ...
        <h1 style="color: #ffffff; font-size: 28px; line-height: 1.25; font-weight: 800; margin: 0 0 10px;">Earn a full year of Mindy Pro &mdash; free.</h1>
        <p style="color: #ddd6fe; font-size: 16px; margin: 0;">A <strong style="color:#ffffff;">$1,788</strong> value &mdash; for one warm introduction.</p>
      </td></tr>
      <tr><td style="padding: 30px 32px 4px;">
        ${P(`${firstName} &mdash; here&rsquo;s how to earn it. Introduce me to one organization that helps small businesses <strong style="color:#0f172a;">learn about government contracting</strong> &mdash; an <strong style="color:#0f172a;">APEX Accelerator, SBDC, trade association, trade union, MBDA / minority business center, or economic development office</strong>, whoever you&rsquo;re closest to. Get them to a quick 20&ndash;30 min look, and the free year is yours.`)}
        ${P(`<strong style="color:#0f172a;">Not sure what to say? Just copy this and send it:</strong>`)}
      </td></tr>
      <tr><td style="padding: 4px 32px 0;">
        ${INTRO_SCRIPT}
      </td></tr>
      <tr><td style="padding: 4px 32px 0;">
        ${P(`When they say yes, reply to me or email <strong>${CLAIM_CC}</strong> &mdash; &ldquo;[Name] is open to a meeting&rdquo; &mdash; and I&rsquo;ll take it from there. That intro is your claim for the free year.`)}
