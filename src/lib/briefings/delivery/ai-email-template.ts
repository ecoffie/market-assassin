  ...
  <div class="container">
    ...
    <div class="footer">
      <p>
        ...
        <a href="${trackingToken ? generateTrackedLink(trackingToken, 'https://tools.govcongiants.org/briefings', 'view_dashboard') : 'https://tools.govcongiants.org/briefings'}">View in dashboard</a> |
        <a href="${trackingToken ? generateTrackedLink(trackingToken, 'https://tools.govcongiants.org/briefings', 'manage_preferences') : 'https://tools.govcongiants.org/briefings'}">Manage preferences</a>
      </p>
