 ...
 */
export function generateAIEmailTemplate(briefing: AIGeneratedBriefing): AIEmailTemplate {
  ...
  return {
    subject,
    preheader,
    htmlBody: generateHtmlBody(briefing, date),
    textBody: generateTextBody(briefing, date),
  };
}
 ...
 */
function generateHtmlBody(briefing: AIGeneratedBriefing, date: string): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 */
function generateTextBody(briefing: AIGeneratedBriefing, date: string): string {
  let text = `
🎁 FREE PREVIEW - Exclusive displacement intel + teaming plays
========================================
