  ...
  <div class="container">
    ...
    <div style="background: #f0fdf4; border: 1px solid #86efac; border-radius: 10px; padding: 16px 20px; margin: 20px 24px; text-align: center;">
      ...
      <div style="display: inline-block;">
        <a href="${trackingToken ? generateTrackedLink(trackingToken, `${MINDY_SITE_URL}/api/feedback?email=${encodedEmail}&type=helpful&source=briefing`, 'feedback_helpful') : `${MINDY_SITE_URL}/api/feedback?email=${encodedEmail}&type=helpful&source=briefing`}" style="background: #22c55e; color: white; padding: 8px 20px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 13px; display: inline-block; margin: 0 6px;">
          👍 Yes
        </a>
        <a href="${trackingToken ? generateTrackedLink(trackingToken, `${MINDY_SITE_URL}/api/feedback?email=${encodedEmail}&type=not_helpful&source=briefing`, 'feedback_not_helpful') : `${MINDY_SITE_URL}/api/feedback?email=${encodedEmail}&type=not_helpful&source=briefing`}" style="background: #ef4444; color: white; padding: 8px 20px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 13px; display: inline-block; margin: 0 6px;">
          👎 No
        </a>
      </div>
    </div>
    ...
    <div class="footer">
      <p>
        Generated by <strong>Mindy AI</strong> | Your Federal BD Intelligence Analyst<br>
        <a href="${trackingToken ? generateTrackedLink(trackingToken, MINDY_APP_URL, 'view_dashboard') : MINDY_APP_URL}">Open Mindy dashboard</a> |
        <a href="${trackingToken ? generateTrackedLink(trackingToken, MINDY_APP_URL, 'manage_preferences') : MINDY_APP_URL}">Manage preferences</a> |
        <a href="${trackingToken ? generateTrackedLink(trackingToken, MINDY_APP_URL, 'unsubscribe') : MINDY_APP_URL}">Unsubscribe</a>
      </p>
...
👍 YES: ${MINDY_SITE_URL}/api/feedback?email=${encodedEmail}&type=helpful&source=briefing
👎 NO: ${MINDY_SITE_URL}/api/feedback?email=${encodedEmail}&type=not_helpful&source=briefing
`;
  }
...
Generated by Mindy AI | Your Federal BD Intelligence Analyst
Open Mindy dashboard: ${MINDY_APP_URL}
Manage preferences: ${MINDY_APP_URL}
Unsubscribe: ${MINDY_APP_URL}
