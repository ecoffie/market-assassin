  ...
  <div class="container">
    ...
    <div class="footer">
      <p>
        ...
        <a href="${trackingToken ? generateTrackedLink(trackingToken, 'https://shop.govcongiants.org/briefings/settings', 'manage_preferences') : 'https://shop.govcongiants.org/briefings/settings'}">Manage preferences</a> |
        <a href="${trackingToken ? generateTrackedLink(trackingToken, 'https://shop.govcongiants.org/briefings/unsubscribe', 'unsubscribe') : 'https://shop.govcongiants.org/briefings/unsubscribe'}">Unsubscribe</a>
      </p>
