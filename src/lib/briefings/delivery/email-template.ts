...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>
        Generated by <strong>Mindy</strong> | Your Market Intelligence Analyst<br>
        <a href="${trackingToken ? generateTrackedLink(trackingToken, 'https://mi.govcongiants.com/briefings', 'manage_preferences') : 'https://mi.govcongiants.com/briefings'}">Manage preferences</a> |
        <a href="${trackingToken ? generateTrackedLink(trackingToken, 'https://mi.govcongiants.com/briefings', 'unsubscribe') : 'https://mi.govcongiants.com/briefings'}">Unsubscribe</a>
      </p>
...
Generated by Mindy | Your Market Intelligence Analyst
Manage preferences: https://mi.govcongiants.com/briefings
Unsubscribe: https://mi.govcongiants.com/briefings
