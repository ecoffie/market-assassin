      ...
      ON T.txn_id = S.txn_id AND T.action_date >= DATE_SUB(DATE('2026-06-06'), INTERVAL 2 DAY)
      ...
      WHEN NOT MATCHED THEN INSERT (
        ...
        contract_pricing_type, set_aside, pop_state, pop_city, pop_country, description, solicitation_identifier, ordering_period_end_date, award_or_idv_flag, idv_type_code, multiple_or_single_award_idv_code, parent_award_agency_id, parent_award_single_or_multiple_code
      ) VALUES (
        ...
        S.contract_pricing_type, S.set_aside, S.pop_state, S.pop_city, S.pop_country, S.description, S.solicitation_identifier, S.ordering_period_end_date, S.award_or_idv_flag, S.idv_type_code, S.multiple_or_single_award_idv_code, S.parent_award_agency_id, S.parent_award_single_or_multiple_code
      )
