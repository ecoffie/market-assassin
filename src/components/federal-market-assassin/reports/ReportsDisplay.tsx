...
<body>
  ...
  <div style="background: linear-gradient(135deg, #fef3c7 0%, #fed7aa 100%); border: 2px solid #f59e0b; border-radius: 12px; padding: 30px; text-align: center; margin-top: 40px;">
    ...
    <p style="color: #78350f; font-weight: bold;">Visit getmindy.ai to upgrade to Premium</p>
  </div>
  `}
  ...
  <div class="report-footer">
    ...
    <p class="report-footer-text">
      ...
      <a href="https://getmindy.ai" style="color: #3b82f6;">getmindy.ai</a> |
      <a href="https://govcongiants.com" style="color: #3b82f6;">govcongiants.com</a>
    </p>
          ...
          <div className="space-y-12">
            ...
            {tier === 'standard' && (
              <div className="print:break-after-page bg-amber-500/10 border-2 border-amber-500/50 rounded-xl p-8 text-center">
                ...
                <p className="text-amber-400 font-bold">Visit getmindy.ai to upgrade</p>
              </div>
            )}
          </div>
        ) : (
