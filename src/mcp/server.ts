 ...
 * Desktop, Cursor, a customer's own tool). (get_winning_playbook — the proprietary
 * teaching corpus — was removed from the MCP surface 2026-07-29; it remains in-app.)
 *
