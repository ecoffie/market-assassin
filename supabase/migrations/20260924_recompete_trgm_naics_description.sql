...
-- Recompete performance Gate 1 (2026-09-24) — trigram index 3/6.
-- Record: tasks/recompete-gate1-2026-09-24.md · prototype: tasks/recompete-trgm-prototype-2026-09-24.md
--
--   index   idx_recompete_trgm_naics_description
--   column  recompete_opportunities.naics_description  (gin, public.gin_trgm_ops — pg_trgm 1.6 lives in public)
--   size    ~1.3 MB, measured on a full copy of the table (2026-09-24)
...
-- invalid: DROP INDEX CONCURRENTLY IF EXISTS public.idx_recompete_trgm_naics_description; then re-run.
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_recompete_trgm_naics_description
  ON public.recompete_opportunities USING gin (naics_description public.gin_trgm_ops);
