...
-- Recompete performance Gate 1 (2026-09-24) — trigram index 6/6.
-- Record: tasks/recompete-gate1-2026-09-24.md · prototype: tasks/recompete-trgm-prototype-2026-09-24.md
--
--   index   idx_recompete_trgm_awarding_sub_agency
--   column  recompete_opportunities.awarding_sub_agency  (gin, public.gin_trgm_ops — pg_trgm 1.6 lives in public)
--   size    ~10 MB, measured on a full copy of the table (2026-09-24)
...
-- invalid: DROP INDEX CONCURRENTLY IF EXISTS public.idx_recompete_trgm_awarding_sub_agency; then re-run.
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_recompete_trgm_awarding_sub_agency
  ON public.recompete_opportunities USING gin (awarding_sub_agency public.gin_trgm_ops);
